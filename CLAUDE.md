...
- **Architecture**: Docker Compose on VPS via Cloudflare Tunnel (dashboard + API + worker) + Cloudflare R2 CDN (widget)
- **Key files**: `docker-compose.prod.yml`, `.github/workflows/ci.yml`, `scripts/deploy.sh`, `docker/postgres/init-prod.sql`
- See **[DEPLOYMENT.md](./DEPLOYMENT.md)** and **[AGENTS.md](./AGENTS.md)** for full deployment details
